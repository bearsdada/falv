	...
	<view id="pageIndex" :style="colorStyle">
		...
		<view class="indexTip" :style="'top:' + (navH + 50) + 'px'" :hidden="iShidden">
			<view class="tip acea-row row-between-wrapper">
				<view class="text">点击“<image src="/static/images/spot.png"></image>
		...
		<view class="privacy-wrapper" v-if="privacyStatus">
			<view class="privacy-box">
				...
				<view class="content">
					...
					你可以阅读
					<navigator url="/pages/users/privacy/index?type=3">《服务协议与隐私政策》</navigator>
					了解详细信息。如你同意，请点击“我同意”开始接受我们的服务。
				</view>
				<view class="btn-box">
